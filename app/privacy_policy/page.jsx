        ...
        <>
            ...
            <section className='md:p-20 px-4 py-20'>
                ...
                <div className='p-6 bg-slate-50 rounded-lg border mt-6'>
                    Visiting our site printpropackaging.com is an acknowledgment of consent to the protection arrangement portrayed on our site. PrintPro Packaging knows well and is dealing with the protection of clients of the site carefully. It is guaranteed that any data which is gathered for the handling of the request or some other inquiry won’t be shared or uncovered to any outsider client, and will warily be utilized just for client service, satisfying delivery demand and for reaching the clients for input.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <h1 className='text-2xl font-bold mb-2'>Information we collect</h1>
                    ...
                    <br />
                    <br />
                    <h1 className='text-2xl font-bold mb-2'>Information use</h1>
                    ...
                    <br />
                    <br />
                    We don’t give, appropriate or sell our site clients and clients’ data to some other gathering. The site clients and clients’ data can be utilized for advertising and improvement of PrintPropackaging.com site, items, services, and limited time offers. It would be ideal if you note we additionally utilize this data, to get in touch with you in regards to essential reports on our site and other data we think might be helpful and important to you.
                    <br />
                    <br />
                    <h1 className='text-2xl font-bold mb-2'>Information Protection</h1>
                    ...
                    <br />
                    <br />
                    <h1 className='text-2xl font-bold mb-2'>Cookies</h1>
                    Do we use cookies? Yes! A cookie is really set of information customized and put away on your PC for an all-inclusive timeframe by our site. A cookie will allow you to utilize our site as a particular individual and identify with your data in our servers/records. Treats should be empowered so as to utilize PrintPropackaging.com site. You can evacuate treats by adhering to guidelines in your internet browser. Every program is somewhat unique, so take a gander at your program Help menu to become familiar with the right method to change your treats. In the event that you turn treats off, you won’t approach numerous highlights that make your site experience progressively proficient and a portion of our services won’t work appropriately. Be that as it may, you can, in any case, utilize numerous highlights of our sit
                    <br />
                    <br />
