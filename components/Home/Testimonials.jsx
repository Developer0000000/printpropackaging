...
export default function Testimonials() {
    return (
        <>
            <div className="md:px-[var(--paddingX)] pt-14 px-4">
                ...
                <div className='grid place-items-center grid-cols-12 mb-20 gap-5'>
                    {
                        TestimonialsData.map((item, index) => (
                            <div key={index} className="md:max-w-sm md:h-48 p-6 col-span-12 sm:col-span-6 md:col-span-4 rounded-lg border border-muted">
