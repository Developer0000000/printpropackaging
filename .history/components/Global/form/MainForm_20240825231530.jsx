    ...
    <form className="text-black" onSubmit={getBestDeal}>
      ...
      <div className="grid grid-cols-12 gap-2 mb-2">
        ...
        <select
          ...
          className="border p-1.5 col-span-12 md:col-span-4 text-black placeholder:text-black"
        >
          <option value="Printing" disabled selected>
            Printing
          </option>
        ...
        >
          ...
          <option value="Soft touch / Silk lamination">
      ...
      <div className="grid grid-cols-12 gap-2 mb-2 border-b-2 border-dashed border-black pb-4">
        ...
        >
          ...
          <option value="210 GSM Cardboard Stock">
            210 GSM Cardboard Stock
          </option>
          <option value="270 GSM Cardboard Stock">
            270 GSM Cardboard Stock
          </option>
          <option value="300 GSM Cardboard Stock">
            300 GSM Cardboard Stock
          </option>
          <option value="310 GSM Cardboard Stock">
            310 GSM Cardboard Stock
          </option>
          <option value="350 GSM Cardboard Stock">
            350 GSM Cardboard Stock
          </option>
          <option value="420 GSM Cardboard Stock">
            420 GSM Cardboard Stock
          </option>
          <option value="500 GSM Cardboard Stock">
            500 GSM Cardboard Stock
          </option>
